...
// Generic SHA-256 block compression (full 16-word message, in-place schedule). Same K and
// round functions as SHA256Transform -> bit-exact SHA-256; only used by the cold 65-byte path.
